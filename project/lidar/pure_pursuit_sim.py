...
class PurePursuit(object):
    ...
    def read_waypoints(self):
        ...
        # filename = os.path.join(dirname, '/home/akash/catkin_ws/src/gem_gnss/waypoints/diamondwp.csv')
        # filename = os.path.join(dirname, '/home/akash/catkin_ws/src/gem_gnss/waypoints/eightwp.csv')
        filename = os.path.join(dirname, '/home/akash/catkin_ws/src/gem_gnss/waypoints/xy_translate.csv')        
